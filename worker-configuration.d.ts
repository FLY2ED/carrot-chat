/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a68c3a12861dc1ec8336f68754390d3)
...
interface __BaseEnv_Env {
	...
	ADMIN_HUB: DurableObjectNamespace<import("./worker/index").AdminHub>;
	USER_INBOX: DurableObjectNamespace<import("./worker/index").UserInbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ChatRoom" | "AdminHub" | "UserInbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_TOKEN" | "JWT_SECRET" | "ALLOW_ANON">> {}
}
